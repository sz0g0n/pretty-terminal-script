...
echo ""
echo ""
echo -e '\033[0;32mTen skrypt (w pełni)  automatycznie skonfiguruje wygląd terminala\033[0m'
echo -e "\033[0;32moraz ustawi zsh jako domyślną powłokę.\033[0m"
echo -e '\033[0;32może zmienić twoje konfiguracjię w niektórych plikach (zrobiony zostanie backup)\033[0m'
...
# automatycznie ustawienia p10k
if grep -q "pretty-terminal" ~/.p10k/powerlevel10k.zsh-theme; then
    echo "plik już zawiera konfiguracjię p10k"
else
